...
Starts = backbone.coder.ops.extractIfDlarray(Starts_);
Ends = backbone.coder.ops.extractIfDlarray(Ends_);
Axes_ = backbone.coder.ops.extractIfDlarray(Axes__);
Steps_ = backbone.coder.ops.extractIfDlarray(Steps__);
numDimsX = backbone.coder.ops.extractIfDlarray(numDimsX_);
